...
#define PAGINATION_USE 						1	/*1 : activation de la pagination, 0 : gestion basique de la m�moire */
...
/**
 * Types pour le r�seau
 * */


#define MAXTRAME 10

typedef char message[MAXTRAME];
